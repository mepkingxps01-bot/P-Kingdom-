...
const UveitisScene = dynamic(() => import("./UveitisScene"), { ssr: false });
const NeuroScene = dynamic(() => import("./NeuroScene"), { ssr: false });
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-3xl mx-auto px-6 py-8">
        <div className={`rounded-2xl overflow-hidden border ${topic.sceneBorder} mb-6`}>
          {topic.scene === "retina" ? <RetinaScene /> : topic.scene === "academy" ? <AcademyScene /> : topic.scene === "uveitis" ? <UveitisScene /> : topic.scene === "neuro" ? <NeuroScene /> : <CorneaScene />}
        </div>
