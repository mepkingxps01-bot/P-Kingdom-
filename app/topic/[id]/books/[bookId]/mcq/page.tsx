        ...
        {!submitted ? (
          ...
          <div className="mt-8 bg-slate-900 border border-cyan-800/40 rounded-2xl p-8 text-center">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <Link href="/topic/cornea/books/cornea-mannis/mcq" className="border border-slate-700 hover:border-slate-500 transition-colors text-slate-300 text-sm px-6 py-3 rounded-xl">
                New Questions
              </Link>
            </div>
          </div>
