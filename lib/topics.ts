...
export const BOOK_DETAILS: Record<string, BookDetail> = {
  ...
  "bcsc-retina": {
    ...
    parts: [
      ...
      {
        id: "part2",
        title: "Part 2: Central Serous Chorioretinopathy",
      ...
      {
        id: "part3",
        title: "Part 3: Acquired Macular Disorders",
        subtitle: "Age-Related Macular Degeneration · Macular Hole · Epiretinal Membrane · VMT",
        questions: 0,
        mcq: 0,
        status: "coming",
      },
      {
        id: "part4",
        title: "Part 4: Retinal Vascular Disease",
      ...
      {
        id: "part5",
        title: "Part 5: Hereditary Retinal & Choroidal Dystrophies",
      ...
      {
        id: "part6",
        title: "Part 6: Intraocular Inflammation & Infection",
      ...
      {
        id: "part7",
        title: "Part 7: Retinal Detachment & Vitreoretinal Surgery",
  ...
  "bcsc-fundamentals": {
    ...
    parts: [
      ...
      {
        id: "part2",
        title: "Part 2: Glaucoma Medications",
      ...
      {
        id: "part4",
        title: "Part 4: Pharmacodynamics & Drug Actions",
      ...
      {
        id: "part5",
        title: "Part 5: Optics of the Human Eye",
      ...
      {
        id: "part6",
        title: "Part 6: Biochemistry, Metabolism & Genetics",
