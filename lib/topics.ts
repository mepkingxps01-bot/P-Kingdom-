...
export const BOOK_DETAILS: Record<string, BookDetail> = {
  ...
  "bcsc-fundamentals": {
    ...
    parts: [
      ...
      {
        id: "part5",
        title: "Part 5: Antiglaucoma Pharmacology — Clinical Drug Guide",
        subtitle: "Miotics · α-Agonists · β-Blockers · CAIs · Prostaglandins · ROCK Inhibitors · EP2 Agonist · Fixed Combos · Systemic & Hyperosmotic · Pregnancy",
        questions: 46,
        mcq: 66,
        status: "available",
      },
      {
        id: "part6",
        title: "Part 6: Ocular Embryology & Development",
      ...
      {
        id: "part9",
        title: "Part 9: Optics of the Human Eye",
