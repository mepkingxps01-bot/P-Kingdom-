...
export const BOOK_DETAILS: Record<string, BookDetail> = {
  ...
  "bcsc-neuro": {
    ...
    parts: [
      ...
      },
      {
        ...
        subtitle: "Upbeat · Torsional (Wallenberg) · Periodic Alternating (PAN) · HINTS & Peripheral vs Central · Acquired Pendular · Oculopalatal Myoclonus · See-Saw · Oculomasticatory Myorhythmia (Whipple) · INO",
        questions: 30,
        mcq: 38,
        status: "available",
      },
      {
        id: "part4",
        title: "Chapter 4: Approach & Management",
        subtitle: "History · Pupils (RAPD/Paradoxical/Anisocoria) · Assessment Parameters · Exam Technique · Investigations · Optical (Minus Lenses/Prisms/CLs) · BoNT-A · Anderson-Kestenbaum",
        questions: 22,
        mcq: 26,
        status: "available",
      },
  ...
  "bcsc-fundamentals": {
    ...
    parts: [
      ...
      {
        id: "part8",
        title: "Part 8: Ocular Surface Pharmacology — Dry Eye & Allergy",
        subtitle: "TFOS DEWS Staging · Artificial Tears & Demulcents · Osmoprotectants · Preservatives · Serum/PRP · Secretagogues · Anti-Inflammatories (CsA, Lifitegrast) · Antihistamines · Mast Cell Stabilizers · Dual-Acting · Steroids · Immunomodulators",
        questions: 38,
        mcq: 48,
        status: "available",
      },
      {
        id: "part9",
        title: "Part 9: Clinical Genetics",
        subtitle: "Pedigrees · AD/AR/X-linked/Mitochondrial · Penetrance & Expressivity · Aneuploidy & Mosaicism · Knudson & Retinoblastoma · Phakomatoses · LHON/CPEO · Ophthalmic Gene Panels · Counseling",
        questions: 46,
        mcq: 64,
        status: "available",
      },
      {
        id: "part10",
        title: "Part 10: Pharmacodynamics & Drug Actions",
      ...
      {
        id: "part11",
        title: "Part 11: Biochemistry & Metabolism",
        subtitle: "Ocular Biochemistry · Free Radicals · Carbohydrate & Lipid Metabolism",
        questions: 0,
        mcq: 0,
        status: "coming",
      },
